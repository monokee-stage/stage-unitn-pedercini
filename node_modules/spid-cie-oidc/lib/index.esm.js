...
import Ajv from 'ajv';
import { isEqual, difference, uniq, isUndefined as isUndefined$1, cloneDeep, intersection } from 'lodash';
...
const undiciHttpClient = (_a) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield undici.request(url, params);
    return {
...
function validateConfiguration(configuration) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const public_jwk of configuration.public_jwks.keys) {
            try {
                yield jose.importJWK(public_jwk, inferAlgForJWK(public_jwk));
            }
            catch (error) {
        ...
        for (const private_jwk of configuration.private_jwks.keys) {
            try {
                yield jose.importJWK(private_jwk, inferAlgForJWK(private_jwk));
            }
            catch (error) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (response.status === 200) {
            ...
            if (!isString(tokens.access_token) ||
                ...
                !(isUndefined$1(tokens.refresh_token) || isString(tokens.refresh_token))) {
...
export { AcrValue, consoleLogger, createAuditLogRotatingFilesystem, createInMemoryAsyncStorage, createLogRotatingFilesystem, createRelyingParty, generateJWKS, noopLogger };
